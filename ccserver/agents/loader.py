...
from ..core.emitter.filter_emitter import VALID_MODES as _OUTPUT_MODES
...
class AgentLoader:
    ...
    def from_workdir(cls, workdir: Path, global_config_dir: Path | None = None) -> "AgentLoader":
        """根据工作目录自动构建标准扫描路径（project-level 优先于 user-level）。"""
    ...
    def _format_tools(a: "AgentDef") -> str:
        ...
        from ..tools.constants import CHILD_DEFAULT_TOOLS
        parts = []
