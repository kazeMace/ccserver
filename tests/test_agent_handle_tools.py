...
# 注意：_notify_parent_done 方法已在 EventBus 重构中删除，
# 其功能由 spawn_background() 中 _forward_bus_events 闭包的 _inject_done_notice 替代。
# 相关行为通过 test_background_agent.py 和 test_event_bus.py 间接覆盖。
